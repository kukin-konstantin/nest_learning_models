...
namespace nest
{
  ...
  STDP_Tsodyk_Connection_Plus::STDP_Tsodyk_Connection_Plus() :
    ConnectionHetWD(),
	tau_psc_(3.0),
    tau_fac_(0.0),
    tau_rec_(800.0),
  ...
  STDP_Tsodyk_Connection_Plus::STDP_Tsodyk_Connection_Plus(const STDP_Tsodyk_Connection_Plus &rhs) :
    ConnectionHetWD(rhs)
  {
  ...
  void STDP_Tsodyk_Connection_Plus::get_status(DictionaryDatum & d) const
  {
   ...
   */
  void STDP_Tsodyk_Connection_Plus::append_properties(DictionaryDatum & d) const
  {
