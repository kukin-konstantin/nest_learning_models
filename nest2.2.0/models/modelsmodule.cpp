...
namespace nest
{
  ...
  void ModelsModule::init(SLIInterpreter *)
  {
    ...
    register_model<iaf_neuron_sm>(net_,    "iaf_neuron_sm");
    register_model<iaf_neuron_dif_alpha>(net_,    "iaf_neuron_dif_alpha");
    register_model<iaf_neuron_dif_alpha_stdp>(net_,    "iaf_neuron_dif_alpha_stdp");
    register_model<iaf_neuron_alpha_online>(net_,    "iaf_neuron_alpha_online");
    register_model<iaf_neuron_stdp_un>(net_,    "iaf_neuron_stdp_un");
    register_model<iaf_neuron_const>(net_,    "iaf_neuron_const");
    ...
    register_model<iaf_psc_exp_mode>(net_,   "iaf_psc_exp_mode");
    ...
    register_prototype_connection<SMConnection>(net_,    "sm_connection");
    register_prototype_connection<Dif_alpha_connection>(net_,    "dif_alpha_connection");
    register_prototype_connection<Dif_alpha_stdp>(net_,    "dif_alpha_stdp");
    ...
    register_prototype_connection<TsodykPoisson>(net_,   "tsodyks_poisson");
    register_prototype_connection<TsodykDifAlpha>(net_,   "tsodyks_dif_alpha");
    ...
    register_prototype_connection<STDP_Tsodyk_Connection>(net_,      "stdp_tsodyk_synapse");
    register_prototype_connection<STDP_Tsodyk_Connection_Plus>(net_,      "stdp_tsodyk_plus_synapse");
    register_prototype_connection<STDPPlus>(net_,"stdp_plus");
    register_prototype_connection<STDPPoisson>(net_,"stdp_poisson");
