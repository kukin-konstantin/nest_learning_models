...
namespace nest
{
  class STDPPlus : public ConnectionHetWD
  {
...
inline
double_t STDPPlus::facilitate_(double_t w, double_t kplus)
{
...
inline 
double_t STDPPlus::depress_(double_t w, double_t kminus)
{
...
inline 
void STDPPlus::check_connection(Node & s, Node & r, rport receptor_type, double_t t_lastspike)
{
 ...
 */
inline
void STDPPlus::send(Event& e, double_t t_lastspike, const CommonSynapseProperties &)
{
