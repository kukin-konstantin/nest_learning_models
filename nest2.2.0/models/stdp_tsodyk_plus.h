...
#ifndef STDP_TSODYK_CONNECTION_PLUS_H
#define STDP_TSODYK_CONNECTION_PLUS_H
...
namespace nest
{
  class STDP_Tsodyk_Connection_Plus : public ConnectionHetWD
  {
   ...
   */
  STDP_Tsodyk_Connection_Plus();

  /**
   * Copy constructor.
   * Needs to be defined properly in order for GenericConnector to work.
   */
  STDP_Tsodyk_Connection_Plus(const STDP_Tsodyk_Connection_Plus &);
...
inline
double_t STDP_Tsodyk_Connection_Plus::facilitate_(double_t w, double_t kplus)
{
...
inline 
double_t STDP_Tsodyk_Connection_Plus::depress_(double_t w, double_t kminus)
{
...
inline 
void STDP_Tsodyk_Connection_Plus::check_connection(Node & s, Node & r, port receptor_type, double_t t_lastspike)
{
 ...
 */
inline
void STDP_Tsodyk_Connection_Plus::send(Event& e, double_t t_lastspike, const CommonSynapseProperties &)
{
...
#endif // of #ifndef STDP_TSODYK_CONNECTION_PLUS_H
