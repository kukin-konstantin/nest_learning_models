...
namespace nest
{
  ...
  STDPPlus::STDPPlus(const STDPPlus &rhs) :
    ConnectionHetWD(rhs)
  {
  ...
  void STDPPlus::get_status(DictionaryDatum & d) const
  {
  ...
  void STDPPlus::set_status(const DictionaryDatum & d, ConnectorModel &cm)
  {
   ...
   */
  void STDPPlus::set_status(const DictionaryDatum & d, index p, ConnectorModel &cm)
  {
   ...
   */
  void STDPPlus::append_properties(DictionaryDatum & d) const
  {
