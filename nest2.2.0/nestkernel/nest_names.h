...
namespace nest
{
  ...
  namespace names
  {
    ...
    //Specific to sm_connection
    extern const Name E;

    //Specific to iaf_neuron_sm
    extern const Name tau_a;
    extern const Name n_in;
    ...
    //learning modules
    //Supervised_behavior
    extern const Name trig_learn_oper;
    extern const Name trig_seal;
    extern const Name number_prim;
    extern const Name bias;
    //Gradient_descent_behavior
    extern const Name time;
    extern const Name I_current;
    extern const Name labmda_function_number;
    extern const Name Th;
    extern const Name k;
